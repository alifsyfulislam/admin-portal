...
$queryResult=$view->ViewMobile();

if (isset($_POST['btn'])){
    $queryResult=$view->SearchMobile();
}
$edit=new EditProduct();
if (isset($_GET['delete'])){
    $check=$_GET['delete'];
    $edit->DeleteMobileById($check);
}
...
<!--                <td>--><?php //echo $show['mobile_id'];?><!--</td>-->
                <td><?php echo $show['mobile_brand'];?></td>
                <td><?php echo $show['mobile_model'];?></td>
<!--                <td>--><?php //echo $show['mobile_code'];?><!--</td>-->
<!--                <td>--><?php //echo $show['mobile_origin'];?><!--</td>-->
                <td><?php echo $show['mobile_wholesale'];?></td>
                <td><?php echo $show['mobile_quantity'];?></td>
<!--                <td>--><?php //echo $show['mobile_description'];?><!--</td>-->
                <td>
                    <a href="viewById.php?id=<?php echo $show['mobile_id'];?>"><i class="fa fa-desktop text-info"></i></a>&nbsp;
                    <a href="editMobile.php?id=<?php echo $show['mobile_id'];?>"><i class="fa fa-edit text-dark"></i></a>&nbsp;
                    <a onclick="return confirm('Are you sure??')" href="?delete=<?php echo $show['mobile_id'];?>"><i class="fa fa-window-close text-danger"></i></a>&nbsp;
                </td>
            </tr>
            <?php } ?>
        </table>
