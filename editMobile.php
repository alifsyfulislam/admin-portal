...
<div class="right-side">
    ...
    <div class="add-form">
        <div class="row input-group">
            ...
            <h3 class="col-md-9 col-sm-8 my-form-control bg-dark text-white" type="text" name="mobile_brand"><?php echo $show['mobile_brand'];?></h3>
        </div>
        <div class="row input-group">
            ...
            <h3 class="col-md-9 col-sm-8 my-form-control bg-dark text-white" type="text" name="mobile_model"><?php echo $show['mobile_model'];?></h3>
        </div>
        <form action="" method="post" class="">
            <div class="row input-group">
                <input class="col-md-12  my-form-control" type="hidden" name="mobile_id" value="<?php echo $show['mobile_id'];?>">
            </div>
            <div class="row input-group">
                <label class="col-md-3 col-sm-4 col-form-label">Mobile Code</label>
                <input class="col-md-9 col-sm-8  my-form-control" type="text" name="mobile_code" value="<?php echo $show['mobile_code'];?>">
            </div>

            <div class="row input-group">
                <label class="col-md-3 col-sm-4 col-form-label">Mobile Origin</label>
                <input class="col-md-9 col-sm-8  my-form-control" type="text" name="mobile_origin" value="<?php echo $show['mobile_origin'];?>">
            </div>

            <div class="row input-group">
                <label class="col-md-3 col-sm-4 col-form-label">Mobile Wholesale</label>
                <input class="col-md-9 col-sm-8  my-form-control" type="number" name="mobile_wholesale" value="<?php echo $show['mobile_wholesale'];?>">
            </div>
            <div class="row input-group">
                <label class="col-md-3 col-sm-4 col-form-label">Mobile Quantity</label>
                <input class="col-md-9 col-sm-8  my-form-control" type="number" name="mobile_quantity" value="<?php echo $show['mobile_quantity'];?>">
            </div>
            <div class="row input-group">
                <label class="col-md-3 col-sm-4 col-form-label">Mobile Description</label>
                <input class="col-md-9 col-sm-8  my-form-control" type="text" name="mobile_description"value="<?php echo $show['mobile_description'];?>">
            </div>
            <div class="row input-group">
                <div class="col-md-12">
